 ...
 */
  ...
  */
 public class SourcesDelegate implements ArtifactDelegate {
     ...
     public ArtifactsResourceResponse getPaginatedArtifactsResponse(String groupId, List<String> nodeList, 
         ...
         DelegatesUtil.logDebugLogs(Constants.SOURCES, groupId, lowerLimit, upperLimit, order, orderBy, isUpdate);
         return DelegatesUtil.getPaginatedArtifactResponse(groupId, nodeList, Constants.SOURCES,
