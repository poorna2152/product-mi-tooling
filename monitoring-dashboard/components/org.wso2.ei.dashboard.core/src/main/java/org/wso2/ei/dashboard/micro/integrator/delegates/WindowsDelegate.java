...
public class WindowsDelegate implements ArtifactDelegate {
    private static final Logger logger = LogManager.getLogger(SourcesDelegate.class);
    ...
    public ArtifactsResourceResponse getPaginatedArtifactsResponse(String groupId, List<String> nodeList,
        ...
        DelegatesUtil.logDebugLogs(Constants.WINDOWS, groupId, lowerLimit, upperLimit, order, orderBy, isUpdate);
        return DelegatesUtil.getPaginatedArtifactResponse(groupId, nodeList, Constants.WINDOWS,
