...
public class GroupsApi {
    ...
    public Response getSiddhiAppsByNodeIds(
        ...
        try {
            ArtifactsResourceResponse siddhiAppsList = siddhiAppsDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
    ...
    public Response getSourcesByNodeIds(
        ...
        try {
            ArtifactsResourceResponse sourcesList = sourcesDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
    ...
    public Response getSinksByNodeIds(
        ...
        try {
            ArtifactsResourceResponse sinkList = sinksDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
    ...
    public Response getQueriesByNodeIds(
        ...
        try {
            ArtifactsResourceResponse queriesList = queryDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
    ...
    public Response getStoresByNodeIds(
        ...
        try {
            ArtifactsResourceResponse storesList = storesDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
    ...
    public Response getWindowsByNodeIds(
        ...
        try {
            ArtifactsResourceResponse aggregationsList = windowsDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
    ...
    public Response getAggregationsByNodeIds(
        ...
        try {
            ArtifactsResourceResponse aggregationsList = aggregationsDelegate.getPaginatedArtifactsResponse(groupId, nodes, searchKey, lowerLimit, upperLimit, order, orderBy, isUpdate);
            responseBuilder = Response.ok().entity(aggregationsList);
        } catch (ManagementApiException e) {
            responseBuilder = Response.status(e.getErrorCode()).entity(getError(e));
        }
