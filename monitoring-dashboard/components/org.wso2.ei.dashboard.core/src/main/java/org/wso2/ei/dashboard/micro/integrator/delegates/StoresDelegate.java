...
public class StoresDelegate implements ArtifactDelegate {
    private static final Logger logger = LogManager.getLogger(StoresDelegate.class);
    ...
    public ArtifactsResourceResponse getPaginatedArtifactsResponse(String groupId, List<String> nodeList,
        ...
        DelegatesUtil.logDebugLogs(Constants.STORES, groupId, lowerLimit, upperLimit, order, orderBy, isUpdate);
        return DelegatesUtil.getPaginatedArtifactResponse(groupId, nodeList, Constants.STORES,
