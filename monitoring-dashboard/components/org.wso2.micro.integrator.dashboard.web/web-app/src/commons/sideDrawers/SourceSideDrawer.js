...
export default function SourceSideDrawer(props) {
            ...
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    ...
                    <Paper className={classes.paper} elevation={0} square>
                        <SourceDetailTable nodeData={nodeData} />
                    </Paper>
                </Grid>
            </Grid>
        </div>
...
function SourceDetailTable(props) {
    const { nodeData } = props;
    const artifactName = nodeData.details.name
        ...
        <TableRow>
            ...
            <TableCell>
                <Editor
                    height="70vh"
                    defaultLanguage="xml"
                    defaultValue={nodeData.details.annotation}
                    options={{
                        readOnly: true
                    }}
                />
