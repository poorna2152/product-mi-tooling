...
public class QueriesDelegate implements ArtifactDelegate {
    ...
    public ArtifactsResourceResponse    getPaginatedArtifactsResponse(String groupId, List<String> nodeList,
        ...
        DelegatesUtil.logDebugLogs(Constants.QUERIES, groupId, lowerLimit, upperLimit, order, orderBy, isUpdate);
        return DelegatesUtil.getPaginatedArtifactResponse(groupId, nodeList, Constants.QUERIES,
