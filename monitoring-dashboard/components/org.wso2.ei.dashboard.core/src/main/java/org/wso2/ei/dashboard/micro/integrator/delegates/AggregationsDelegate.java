...
public class AggregationsDelegate implements ArtifactDelegate {
    private static final Logger logger = LogManager.getLogger(AggregationsDelegate.class);
    ...
    public ArtifactsResourceResponse getPaginatedArtifactsResponse(String groupId, List<String> nodeList,
        ...
        DelegatesUtil.logDebugLogs(Constants.AGGREGATIONS, groupId, lowerLimit, upperLimit, order, orderBy, isUpdate);
        return DelegatesUtil.getPaginatedArtifactResponse(groupId, nodeList, Constants.AGGREGATIONS,
