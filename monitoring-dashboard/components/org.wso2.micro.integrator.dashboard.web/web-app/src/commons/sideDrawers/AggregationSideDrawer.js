...
export default function AggregationSideDrawer(props) {
    const { nodeData } = props;
    const nodeId = nodeData.nodeId;
    const artifactName = nodeData.details.name;
    const source = nodeData.details;
                ...
                <Grid item xs={12}>
                    ...
                    <SourceViewSection
                        ...
                        designContent={<>
                            ...
                            <AggregationDetailTable nodeData={nodeData} />
                            </Paper>
                        </>}
                    />
                </Grid>
...
function AggregationDetailTable(props) {
    const { nodeData } = props;
    const artifactName = nodeData.details.name
